...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        //1
       Map<String, Long> trInfo = transactionStream
            .collect(Collectors.groupingBy(transaction -> transaction.getAccount().getId(), Collectors.summingLong(Transaction::getSum)));
       System.out.println(trInfo);
        ...
        int sum = transactionStream.mapToInt(Transaction::getSum).sum();
        System.out.println("Сумма транзакций: " + sum);
